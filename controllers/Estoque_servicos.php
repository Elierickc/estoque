...
class Estoque_servicos extends Admin_controller
{
    ...
    {
        // ⚡ Bolt Optimization: Removed redundant call to get_servicos().
        // This method was previously calling the same model function twice,
        // causing an unnecessary second database query on every page load.
        // By removing the duplicate, we cut the database load for this action in half.
